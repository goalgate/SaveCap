...
public class AnalysisActivity extends Activity implements IPhotoView {

    private static final String SERIAL_NUM = "A9C2-6117-6712-073F";

    String TAG = AnalysisActivity.class.getSimpleName();
...
//        model = getIntent().getIntExtra("model_type", MODEL_DETECT);
        model = config.getInt("model_type", MODEL_DETECT);
    ...
    private void choosePlatform() {
        String soc = config.getString("soc");
//        String soc = getIntent().getStringExtra("soc");
    ...
    private void initManager() {
        ...
        String ak = config.getString("ak");
        String sk = config.getString("sk");
